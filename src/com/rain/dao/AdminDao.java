...
public class AdminDao {
	 ...
	 * @param max_num
	 */
	public void Register(String username, String password, String name, String email, String phone, String deposit, int lend_num,int max_num) {
		// TODO Auto-generated method stub
				Connection conn = DBUtil.getConnectDb();
				String sql = "insert  into admin(status,username,password,name,email,phone,deposit,lend_num,max_num) values(?,?,?,?,?,?,?,?,?)";
				int rs = 0;
				PreparedStatement stm = null;
				try {
					stm = conn.prepareStatement(sql);
					...
					stm.setString(7, deposit);
					stm.setInt(8, lend_num);
					stm.setInt(9, max_num);
...
//			stm.setString(1,name);
			...
			if(rs.next()){
				...
				adminbean.setDeposit(rs.getString("deposit"));
	 ...
	 * 修改读者的信息，
	 */
	public void updateUser(int aid, String username, String password, String name, String email, String phone,String deposit,
			int lend_num, int max_num) {
		// TODO Auto-generated method stub
		Connection conn = DBUtil.getConnectDb();
		String sql = "update admin set username=?,name=?,email=?,phone=?,deposit=?,password=?,lend_num=?,max_num=? where aid=?";
		PreparedStatement stm = null;
		try {
			stm = conn.prepareStatement(sql);
	...
	public AdminBean get_UsernameInfo(String username){
		AdminBean adminbean = new AdminBean();
		Connection conn = DBUtil.getConnectDb();
