...
ArrayList<TypeBean> data = (ArrayList<TypeBean>)typedao.get_ListInfo();
  ...
  %>                 <option value="<%= bean.getName() %>"><%= bean.getName() %></option>                        <%} %>                                        
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">在册数</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="updateNownum" name="nownum"  placeholder="请输入在册数">
												<label class="control-label" for="updatePress" style="display: none;"></label>
												</div>
										</div>	
										</div>
  ...
  %>                 <option value="<%= bean.getName() %>"><%= bean.getName() %></option>                        <%} %>
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">在册数</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" id="addNownum" required="required" name="nownum" placeholder="请输入图书在册数">
												<label class="control-label" for="addNum" style="display: none;"></label>	
												</div>
										</div>
