            ...
            <ul class="nav navbar-collapse collapse bootstrap-admin-navbar-side">
               <li>
	            ...
	            <li>
	                ...
	                <li>
	                    <a href="/books/donation.html"><i class="glyphicon glyphicon-chevron-right"></i> 我要捐献</a>
	                </li>
...
<button type="button" class="btn btn-info btn-xs" data-toggle="modal" onclick="renewbook(<%= bean.getHid() %>)">续借</button>
	                                </td>                                               
                          	  </tbody>
                             <%} %> 
                        </table>
    ...
    function renewbook(hid) {
    	con=confirm("是否续借?"); 
    	if(con==true){
    		location.href = "/books/borrowServlet?tip=3&hid="+hid;
    	}
    }
    </script>
        </div>
...
<!-------------------------------------------------------------->  
			...
			<input type="text" class="form-control" id="email" name="email"  placeholder="请输入您的邮箱" value='<% out.write(admin.getEmail());%>'>
							...
							<div class="form-group">
								...
								<div class="col-sm-7">
			<input type="text" class="form-control" id="deposit" name="deposit"  placeholder="请输入您的押金" value='<% out.write(admin.getDeposit() );%>'>
											<label class="control-label" for="deposit" style="display: none"></label>				
								</div>
							</div>	
