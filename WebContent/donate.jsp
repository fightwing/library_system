...
<%@ page import = "com.rain.bean.HistoryBean,com.rain.bean.Donation,com.rain.dao.AdminDao,com.rain.dao.DonationDao,com.rain.dao.TypeDao,com.rain.dao.BookDao,com.rain.bean.AdminBean" %>
        ...
        <div class="row">
            ...
            <div class="col-md-2 bootstrap-admin-col-left">
                <ul class="nav navbar-collapse collapse bootstrap-admin-navbar-side">
                    ...
                    <li>
                        <a href="/books/donate.jsp"><i class="glyphicon glyphicon-chevron-right"></i> 捐献申请信息</a>
                    </li>
                </ul>
                    ...
                    <div class="col-lg-12">
                        <div class="panel panel-default bootstrap-admin-no-table-panel">
                            <div class="panel-heading">
                                <div class="text-muted bootstrap-admin-box-title">捐献申请信息</div>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <table id="data_list" class="table table-hover table-bordered" cellspacing="0" width="100%">
                            ...
                            <!---在此插入信息-->
                             <%
                             ArrayList<Donation> bookdata = new ArrayList<Donation>();
                             bookdata = (ArrayList<Donation>)request.getAttribute("data");
                           if(bookdata==null){
                        	   DonationDao donationdao = new DonationDao();
                        	   bookdata = (ArrayList<Donation>)donationdao.get_donationInfo();
                           }
  for (Donation bean : bookdata){
  %>                 
                            	<tbody>
	                         	   	
	                         	   	<td><%= bean.getBookname() %></td>
	                                <td><%= bean.getName() %></td>
	                                <td><%= bean.getBooknumber() %></td>
