...
<button type="button" class="btn btn-danger btn-xs" onclick="deletebook(<%= bean.getAid() %>)">删除</button>
    ...
    function showInfo2(aid,username,name,email,phone,password,lend_num,max_num,deposit) {
...
<div class="col-sm-7">
<input type="text" class="form-control" id="updatedeposit" name="deposit"  placeholder="">
<label class="control-label" for="updatePress" style="display: none;"></label>
</div>
</div>
<div class="form-group">	
                                 ...
                                 <form class="form-horizontal" method="post" action="/books/AddUserServlet">   <!--保证样式水平不混乱-->   
									...
									<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
										...
										<div class="form-group">	
											<label for="firstname" class="col-sm-3 control-label">押金</label>
												<div class="col-sm-7">
													<input type="text" class="form-control" name="deposit" id="addDeposit" required="required"   placeholder="请输入押金">
												<label class="control-label" for="addDeposit" style="display: none;"></label>	
												</div>
										</div>
